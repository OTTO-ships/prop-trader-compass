        ...
        <ScrollFade>
          <section className="rounded-lg border border-border/40 bg-card p-5 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <InputField label="Account Size" value={accountSize} onChange={setAccountSize} prefix="$" />
              <InputField label="Daily Drawdown" value={dailyDD} onChange={setDailyDD} suffix="%" />
              <InputField label="Max Overall Drawdown" value={maxDD} onChange={setMaxDD} suffix="%" />
              <InputField label="Profit Target" value={profitTarget} onChange={setProfitTarget} suffix="%" />
            </div>
          </section>
        </ScrollFade>
